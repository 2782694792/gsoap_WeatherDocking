...
@note HINTS:
 - Run soapcpp2 on serviceIn.h to generate the SOAP/XML processing logic:
...
/// Pointer to array char* of size 0..unbounded.
    char*                               *string                         0;	///< Multiple elements.
...
/// Element "theRegionCode" of type xs:string.
    char*                                theRegionCode                  0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
/// Element "theCityCode" of type xs:string.
    char*                                theCityCode                    0;	///< Optional element.
