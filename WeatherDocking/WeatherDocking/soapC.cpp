...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.124 2022-12-22 02:49:45 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerTo_ns1__getWeather:
		return soap_in_PointerTo_ns1__getWeather(soap, tag, NULL, "ns1:getWeather");
	case SOAP_TYPE_PointerTo_ns1__getSupportCityString:
		return soap_in_PointerTo_ns1__getSupportCityString(soap, tag, NULL, "ns1:getSupportCityString");
	case SOAP_TYPE_PointerTo_ns1__getSupportCityDataset:
		return soap_in_PointerTo_ns1__getSupportCityDataset(soap, tag, NULL, "ns1:getSupportCityDataset");
	case SOAP_TYPE_PointerTo_ns1__getRegionCountry:
		return soap_in_PointerTo_ns1__getRegionCountry(soap, tag, NULL, "ns1:getRegionCountry");
	case SOAP_TYPE_PointerTo_ns1__getRegionProvince:
		return soap_in_PointerTo_ns1__getRegionProvince(soap, tag, NULL, "ns1:getRegionProvince");
	case SOAP_TYPE_PointerTo_ns1__getRegionDataset:
		return soap_in_PointerTo_ns1__getRegionDataset(soap, tag, NULL, "ns1:getRegionDataset");
	case SOAP_TYPE_PointerTo_ns1__getSupportCityDatasetResponse_getSupportCityDatasetResult:
		return soap_in_PointerTo_ns1__getSupportCityDatasetResponse_getSupportCityDatasetResult(soap, tag, NULL, "ns1:getSupportCityDatasetResponse-getSupportCityDatasetResult");
	...
	case SOAP_TYPE_PointerTo_ns1__getRegionDatasetResponse_getRegionDatasetResult:
		return soap_in_PointerTo_ns1__getRegionDatasetResponse_getRegionDatasetResult(soap, tag, NULL, "ns1:getRegionDatasetResponse-getRegionDatasetResult");
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getSupportCityDatasetResponse_getSupportCityDatasetResult(struct soap *soap, const char *tag, int id, const _ns1__getSupportCityDatasetResponse_getSupportCityDatasetResult *a, const char *type)
{
	...
	{	if (soap_element_empty(soap, "xsd:schema", 0, NULL))
			return soap->error;
	}
	else if (soap_outliteral(soap, "xsd:schema", (char*const*)&a->_ns1__getSupportCityDatasetResponse_getSupportCityDatasetResult::xsd__schema, NULL))
		return soap->error;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getRegionDatasetResponse_getRegionDatasetResult(struct soap *soap, const char *tag, int id, const _ns1__getRegionDatasetResponse_getRegionDatasetResult *a, const char *type)
{
	...
	else if (soap_outliteral(soap, "xsd:schema", (char*const*)&a->_ns1__getRegionDatasetResponse_getRegionDatasetResult::xsd__schema, NULL))
		return soap->error;
...
void _ns1__getWeather::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__string(soap, &this->_ns1__getWeather::theCityCode);
	soap_serialize_PointerTostd__string(soap, &this->_ns1__getWeather::theUserID);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getWeather(struct soap *soap, const char *tag, int id, const _ns1__getWeather *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__getWeather), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns1:theCityCode", -1, &a->_ns1__getWeather::theCityCode, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns1:theUserID", -1, &a->_ns1__getWeather::theUserID, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__getWeather * SOAP_FMAC4 soap_in__ns1__getWeather(struct soap *soap, const char *tag, _ns1__getWeather *a, const char *type)
{
	...
	if (soap->body && *soap->href != '#')
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (soap_in_PointerTostd__string(soap, "ns1:theCityCode", &a->_ns1__getWeather::theCityCode, "xsd:string"))
				{	soap_flag_theCityCode1--;
					continue;
				}
			}
			if (soap_flag_theUserID1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
			{	if (soap_in_PointerTostd__string(soap, "ns1:theUserID", &a->_ns1__getWeather::theUserID, "xsd:string"))
...
void _ns1__getSupportCityString::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__string(soap, &this->_ns1__getSupportCityString::theRegionCode);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getSupportCityString(struct soap *soap, const char *tag, int id, const _ns1__getSupportCityString *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__getSupportCityString), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns1:theRegionCode", -1, &a->_ns1__getSupportCityString::theRegionCode, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__getSupportCityString * SOAP_FMAC4 soap_in__ns1__getSupportCityString(struct soap *soap, const char *tag, _ns1__getSupportCityString *a, const char *type)
{
	...
	if (soap->body && *soap->href != '#')
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (soap_in_PointerTostd__string(soap, "ns1:theRegionCode", &a->_ns1__getSupportCityString::theRegionCode, "xsd:string"))
...
void _ns1__getSupportCityDataset::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__string(soap, &this->_ns1__getSupportCityDataset::theRegionCode);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getSupportCityDataset(struct soap *soap, const char *tag, int id, const _ns1__getSupportCityDataset *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__getSupportCityDataset), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns1:theRegionCode", -1, &a->_ns1__getSupportCityDataset::theRegionCode, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__getSupportCityDataset * SOAP_FMAC4 soap_in__ns1__getSupportCityDataset(struct soap *soap, const char *tag, _ns1__getSupportCityDataset *a, const char *type)
{
	...
	if (soap->body && *soap->href != '#')
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_theRegionCode1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
			{	if (soap_in_PointerTostd__string(soap, "ns1:theRegionCode", &a->_ns1__getSupportCityDataset::theRegionCode, "xsd:string"))
				{	soap_flag_theRegionCode1--;
					continue;
				}
			}
